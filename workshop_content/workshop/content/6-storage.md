...
You can see all the files you created.  Next, let's open the file we created and see the contents
...
```
#### 7. Exit the session
Then exit the session by typing
